...
public abstract class Decryptor implements Cloneable {
     ...
     * {@link #getDataStream(com.moparisthebest.poi.poifs.filesystem.DirectoryNode)}.
     * Just reading to the end of the input stream is not sufficient because there are
     * normally padding bytes that must be discarded
     *
     * <p>
     *    The length variable is initialized in {@link #getDataStream(com.moparisthebest.poi.poifs.filesystem.DirectoryNode)},
     ...
     * @throws IllegalStateException if {@link #getDataStream(com.moparisthebest.poi.poifs.filesystem.DirectoryNode)}
     * was not called
     */
